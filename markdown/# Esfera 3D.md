...
Este documento detalla un script en Python que utiliza las bibliotecas GLFW y OpenGL para crear una esfera en 3D que rota sobre su eje y se mueve de manera oscilante. A continuación, se desglosa cada parte del código y su funcionalidad.
...
def init():
    glClearColor(0.5, 0.8, 1.0, 1.0)  # Fondo azul claro

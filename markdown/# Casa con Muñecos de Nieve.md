# Casa con Muñecos de Nieve

Este documento detalla un script en Python que utiliza las bibliotecas GLFW y OpenGL para generar una escena 3D en la que se dibujan varias casas. A continuación, se desglosa cada parte del código y su funcionalidad.

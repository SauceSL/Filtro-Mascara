...
Este documento detalla un script en Python que utiliza la biblioteca OpenCV para crear y manipular imágenes a través de primitivas gráficas como círculos, líneas y polígonos. A continuación, se desglosa cada parte del código y su funcionalidad.
...
# Crear una imagen en blanco de 500x500 píxeles con 3 canales de color (RGB)
img = np.ones((500, 500, 3), dtype=np.uint8) * 255 

# Dibujar un círculo amarillo (color RGB: (0, 234, 21)) de radio 50
cv.circle(img, (250, 250), 50, (0, 234, 21), -1)

# Dibujar un círculo negro de radio 30 en el mismo centro

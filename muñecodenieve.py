...
def draw_snowman():
    ...
    # glRotatef(rotation_angle, 0, 0, 1)  # Rotación en el eje Y (comentada para detener la rotación)
    # Cuerpo
    glColor3f(1, 1, 1)
...
def update_motion():
    ...
    # Actualizar el ángulo de rotación (comentada para detener la rotación)
    # rotation_angle += 3  # Incrementa para que el muñeco gire más lento
